 ...
 * Aylin Hosseinchi
 *
 * This is the class for checking and updating the weather forecast for 10 days
 */
...
public class ForecastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int h = Objects.requireNonNull(receivedIntet.getExtras()).getInt(getString(R.string.hour));
